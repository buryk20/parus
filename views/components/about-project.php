        ...
        <div class="main-style-text about-project__wrp-text">
            ...
            <div class="about-project__wrp-list">
                <ul>
                    ...
                    <li>
                        <a style="color: #49a39e" href="https://e-construction.gov.ua/document_detail/doc_id=3419852012903204315/optype=100">Дозвіл на початок будівельних робіт</a> засвідчує повну відповідність проєкту будівельним нормам та законодавству
                    </li>
                </ul>
            </div>
        </div>
